...
export const metadata = {
  title: "Buying a Home | Stacy and Louise Anastasiadis",
  description:
    "Buying a home with Stacy and Louise Anastasiadis. We can help you find the home of your dreams in the shortest amount of time around London.",
};
        ...
        <div className="max-w-4xl mx-auto px-4 py-12 sm:py-16 lg:py-20">
            ...
            <div className="prose max-w-none">
              ...
              <div className="mb-10">
                ...
                <p className="text-gray-700 leading-relaxed">
                  ...
                  additional expenses like moving costs, new appliances, and
                  home furnishings.
                </p>
              </div>
              ...
              <div className="mb-10">
                ...
                <p className="text-gray-700 leading-relaxed mb-4">
                  ...
                  you have an unlimited budget, expect to make some compromises
                  in your search.
                </p>
                <p className="text-gray-700 leading-relaxed">
          ...
          <section className="mb-12">
            ...
            <div className="bg-gray-50 p-6 rounded-lg mb-8">
              ...
              <p className="text-gray-700 mb-4">
                Start your mortgage pre-qualification early. Various
                institutions offer mortgages: banks, trust companies, credit
                unions, pension funds, and more. Compare multiple lenders as
                terms and options vary significantly.
              </p>
            ...
            <div className="bg-gray-50 p-6 rounded-lg">
              ...
              <p className="text-gray-700 mb-4">
                ...
                evaluate the property's condition, identify issues, and
                highlight potential concerns. Every inspection should cover:
              </p>
