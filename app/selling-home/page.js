    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        ...
        <section className="mb-16">
          <h2 className="text-3xl font-bold mb-6">Staging Market Advantage</h2>
          ...
          <div className="prose max-w-none">
            ...
            <p className="mb-8">
              ...
              appealing spaces that allow potential buyers to mentally move in,
              effectively turning your property into their future home.
            </p>
          </div>
        </section>
        ...
        <section className="mb-16">
          ...
          <div className="prose max-w-none">
            <p className="mb-6">
              ...
              appearance suggests comprehensive care, including unseen elements
              like plumbing and heating systems.
            </p>
        ...
        <section className="mb-16">
          ...
          <div className="prose max-w-none">
            ...
            <ul className="list-disc pl-6 space-y-3 mb-8">
              ...
              <li>Well-maintained landscaping with trimmed lawns and bushes</li>
