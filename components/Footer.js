  ...
  return (
    <footer className="relative bg-gray-50 text-gray-800">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-16">
        <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-8 text-center lg:text-left">
          {/* Logo and Contact */}
          ...
          {/* Areas Served */}
          <div>
            <h3 className="text-gray-900 font-semibold mb-4">Areas Served</h3>
            <ul className="space-y-3">
